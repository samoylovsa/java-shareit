...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItemRequest(CreateItemRequestDto createItemRequestDto, Integer userId) {
        return post("", userId, createItemRequestDto);
    }

    public ResponseEntity<Object> getUserItemRequests(Integer userId) {
        return get("", userId);
    }
